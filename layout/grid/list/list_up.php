	<link href="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.demo-pages.min.css'; ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.core.min.css'; ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.pagination-bundle.min.css'; ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.history-bundle.min.css'; ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.textbox-filter.min.css'; ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.list-grid-view.min.css'; ?>" rel="stylesheet" type="text/css">

	<script src="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.core.min.js'; ?>"></script>
	<script src="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.history-bundle.min.js'; ?>"></script>
	<script src="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.jquery-ui-bundle.min.js'; ?>"></script>
	<script src="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.pagination-bundle.min.js'; ?>"></script>
	<script src="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.sort-bundle.min.js'; ?>"></script>
	<script src="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.textbox-filter.min.js'; ?>"></script>
	<script src="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jplist.list-grid-view.min.js'; ?>"></script>
	<script src="<?php echo plugins_url() . '/' . upg_FOLDER . '/layout/grid/list/res/jquery.lazyload.min.js'; ?>"></script>
	<script>
