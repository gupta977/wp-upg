...
?>
        ...
        <fieldset>
            <div class="pure-control-group">
                ...
                <input class="pure-input-1 pure-input-rounded" id="name" name="user-submitted-title" type="text"
                    value="" placeholder="<?php _e('Post Title', 'wp-upg'); ?>" required>
            </div>
            ...
            <div class="pure-control-group">
                ...
                <textarea class="pure-input-1 pure-input-rounded" id="desp" name="user-submitted-content" rows="5"
                    placeholder="<?php _e('Post Content', 'wp-upg'); ?>" required></textarea>
            </div>
            <?php
            }
            } else {
            ...
            ob_start();
                ...
                <input class="pure-input-1-2 pure-input-rounded" accept="image/*" id="file"
                    name="user-submitted-image[]" type="file" size="25" <?php
            ...
            <ul>
                ...
                <li><?php echo _e('Maximum upload file size limit:', 'wp-upg') ?>
                    <b><?php //echo ini_get('post_max_size');?> <?php echo size_format(wp_max_upload_size()); ?></b>
                </li>
            </ul>
        ...
        for ($x = 1; $x <= 5; $x++) {
            ...
            <div class="pure-control-group">
                <label for="upg_custom_field_<?php echo $x; ?>" class="pure-checkbox">
                    <input type="checkbox" name="upg_custom_field_<?php echo $x; ?>"
                        value="<?php echo 'upg_custom_field_'.$x.'_checked'; ?>">
        ...
        ?>
            ...
            <div class="pure-controls">
                <button type="submit" name="SN" class="pure-button pure-button-primary"><i
                        class="fas fa-file-upload"></i> <?php esc_html_e('Post', 'wp-upg'); ?></button>
                <button type="reset" value="<?php esc_html_e('Reset', 'wp-upg'); ?>"
                    class="pure-button"><?php esc_html_e('Reset', 'wp-upg'); ?></button>
