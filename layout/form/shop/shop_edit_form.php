...
<fieldset>
       <label for="user-submitted-title">Product Name</label>
            <input class="pure-input-1 pure-input-rounded" id="name" name="user-submitted-title" type="text" value="<?php echo $post->post_title; ?>" placeholder="<?php _e('Item Title', 'wp-upg'); ?>" required>
      
	   <div class="pure-g">
            <div class="pure-u-1 pure-u-md-1-3">
                <label for="upg_custom_field_1"><?php echo $options['upg_custom_field_1']; ?></label>
                <input id="upg_custom_field_1" name="upg_custom_field_1" class="pure-u-23-24" type="text" placeholder="0" value="<?php echo upg_get_value('upg_custom_field_1',$post); ?>" required>
            </div>

            <div class="pure-u-1 pure-u-md-1-3">
                <label for="upg_custom_field_2"><?php echo $options['upg_custom_field_2']; ?></label>
                <input id="upg_custom_field_2" name="upg_custom_field_2" class="pure-u-23-24" type="text" placeholder="0" value="<?php echo upg_get_value('upg_custom_field_2',$post); ?>">
            </div>

            <div class="pure-u-1 pure-u-md-1-3">
			
               <label for="cat"><?php _e('Select category', 'wp-upg'); ?></label>
         <?php echo upg_droplist_category(upg_get_album($post,'name')); ?>
		...
		?>
		  ...
		  <label for="upg_custom_field_5"><?php echo $options['upg_custom_field_5']; ?></label>
                <input id="upg_custom_field_5" name="upg_custom_field_5" class="pure-u-23-24" type="text" placeholder="Eg. Gift hamper on each purchase." value="<?php echo upg_get_value('upg_custom_field_5',$post); ?>">
		...
		?>
		 ...
		 <div class="pure-controls">
			...
			<?php wp_nonce_field('upg-nonce', 'upg-nonce', false); ?> <input type="reset">
		</div>
</fieldset>
</form>	